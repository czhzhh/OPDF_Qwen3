...
from mpoqwen import QwenModelCustom
...
def main():
    ...
    model = QwenModelCustom.from_pretrained(
    ...
    if tokenizer.pad_token is not None:
        t_config.pad_token_id = tokenizer.pad_token_id
    teacher_model = QwenModelCustom.from_pretrained(
        model_args.teacher_model,
        from_tf=bool(".ckpt" in model_args.model_name_or_path),
        config=t_config,
        cache_dir=model_args.cache_dir,
